...
import { createAllTeachers, createTeacher, deleteTeacher, deleteTeachers, getTeachers, getTeachersForFilter, repairTeachers } from "../controllers/teacher.controller";
